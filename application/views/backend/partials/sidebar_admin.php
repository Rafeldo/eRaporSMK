			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'config') ?  'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
					...
					foreach($data_siswa as $siswa){
						$anggota = Anggotarombel::find_by_ajaran_id_and_rombel_id_and_siswa_id($ajaran->id, $siswa->data_rombel_id, $siswa->id);					if($anggota){
						} else {
						?>
