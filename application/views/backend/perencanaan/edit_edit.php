					...
					<th>
						<table>
							<tr>
								...
								<td>&nbsp;:&nbsp;</td>
								<td>
									<input size='10' value="<?php echo $group->nama_penilaian;?>" disabled />
									<input name="nama_penilaian[]" type="hidden" value="<?php echo $rencana->id_mapel; ?>" />
								</td>
							</tr>
							<tr>
								<td>Metode </td>
								...
								<td>
									<select disabled="disabled">
										...
										<option value="<?php echo $key; ?>"<?php echo isset($group->bentuk_penilaian) ? ($group->bentuk_penilaian == $key) ? 'selected="selected" ' : '' : ''; ?>><?php echo $value; ?></option>
										<?php } ?>
									</select>
									<input name="bentuk_penilaian[]" type="hidden" value="<?php echo $group->bentuk_penilaian; ?>" />
								</td>
							</tr>
							<tr>
								<td>Bobot </td>
