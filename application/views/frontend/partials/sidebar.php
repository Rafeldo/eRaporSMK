...
<aside class="main-sidebar">              
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'referensi') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'referensi' && isset($uri[3]) && $uri[3] == 'kkm') ?  ' class="active"' : ''; ?>>
					...
					isset($uri[3]) && $uri[3] == 'edit_kurikulum'
                	    ...
                	    <i class="fa fa-hand-o-right"></i> <span>Referensi Kurikulum</span>
		                </a>
        		    </li>
					<li<?php echo (isset($activemenu) && $activemenu == 'referensi' && 
			...
			<?php if($this->ion_auth->in_group($super_admin) || $cari_rombel){?>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'laporan' && isset($uri[3]) && $uri[3] == 'prakerin') ?  ' class="active"' : ''; ?>>
						<a href="<?php echo site_url('admin/laporan/prakerin'); ?>"><i class="fa fa-hand-o-right"></i> Prakerin</a>
					</li>
			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'monitoring') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'laporan' && isset($uri[3]) && $uri[3] == 'rapor') ?  ' class="active"' : ''; ?>>
						<a href="<?php echo site_url('admin/monitoring/rapor'); ?>"><i class="fa fa-hand-o-right"></i> Cetak Rapor</a>
					</li>
					<?php } ?>
					<?php if($this->ion_auth->in_group($admin_group)){?>
