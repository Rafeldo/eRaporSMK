...
class Ajaxpenerimaan extends Backend_Controller {
	...
	public function get_rombel_siswa(){
		$siswa_id = $_POST['siswa_id'];
		//$siswa_id =4;
		$ajaran_id = get_ta()->id;
		//$tingkat = 10;
		$dataAnggotaRombel = Anggotarombel::find_all_by_siswa_id_and_ajaran_id($siswa_id,$ajaran_id);
		foreach($dataAnggotaRombel as $AnggotaRombel){
			$rombel_id[] = $AnggotaRombel->rombel_id;
		}
