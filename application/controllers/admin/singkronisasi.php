...
class Singkronisasi extends Backend_Controller {
	...
	public function index(){
		...
		->set('page_title', 'Singkronisasi Erapor dengan Dapodik')
   ...
   type="button"> Login
        ...
        ->build($this->admin_folder.'/singkron/singkron', $data);
	}
	function guru(){
